...
def show_admin_window():
    ...
    def show_instructor_info():
        ...
        instructor_tree.column("Name", width=300, anchor="center")  # Adjust width for 'Name'
        instructor_tree.column("Expertise Area", width=300, anchor="center")  # Adjust width for 'Expertise Area'
        instructor_tree.column("Available Time", width=300, anchor="center")  # Adjust width for 'Available Time'
    ...
    def show_class_info():
        ...
        class_tree.column("Class Name", width=400, anchor="center")  # Wider width for class names
        class_tree.column("Schedule", width=400, anchor="center")  # Wider width for time slots

        for col in class_columns:
            class_tree.heading(col, text=col)

        # Static class data (original static data in the code)
        classes = [
    ...
    show_customer_info()  # Show customer info when the window opens
